{{-- resources/views/espacios/create.blade.php --}}
@extends('layouts.app')
...
<main class="container py-5">
  <div class="row justify-content-center">
    <div class="col-12 col-lg-10">
      ...
      <h1 class="mb-4 text-center">Nuevo espacio</h1>
                  ...
                  @foreach($items as $item)
                    <li class="px-1">
                      <div class="form-check">
                        <input class="form-check-input equip-checkbox"
                               type="checkbox"
                               name="equipamiento[]"
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">
                @if(session('success')) ¡Éxito! @else Ha ocurrido un error @endif
              </h5>
            ...
            <div class="modal-footer">
              ...
              @else
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Volver y corregir</button>
              @endif
            </div>
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
  // 1) Disparar modal si viene success o errores
  @if(session('success') || $errors->any())
  ...
  // 2) Lógica de “chips” Equipamiento
